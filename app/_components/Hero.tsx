    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white leading-tight mb-4">
          Rădulescu
          <br />
          <span className="text-cyan-400">Roberto-Damian</span>
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded border border-cyan-500/60 text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-400 transition-all font-mono text-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded border border-zinc-700 text-zinc-300 hover:border-cyan-500/60 hover:text-cyan-400 transition-all font-mono text-sm"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
