...
export default function Header() {
  return (
    <div className='w-[22rem] md:w-[29rem] lg:w-[35rem] mx-auto mt-36 relative'>
      ...
      <div className='w-7 md:w-11 lg:w-14 absolute right-36 md:right-48 top-14 md:top-16 lg:top-[4.5rem] lg:right-52'>
        <Image src={waving_hand} alt='waving-hand-emoji' />
      </div>
      ...
      <div className='hidden md:flex mt-12 w-full justify-between items-center'>
